...
(() => {
  ...
  function ae(e) {
    ...
    function u(e) {
      return (
        ...
        !(
          ...
          x() - a < t.params.mousewheel.thresholdTime
        ) &&
        ((e.delta >= 6 && x() - a < 60) ||
          (e.direction < 0
    ...
    function h(e) {
      ...
      if (
        ("container" !== t.params.mousewheel.eventsTarget &&
          (a = S(t.params.mousewheel.eventsTarget)),
        !t.mouseEntered && !a[0].contains(s.target) && !r.releaseOnEdges)
      )
        return !0;
      ...
      if (0 === c) return !0;
      r.invert && (c = -c);
      let g = t.getTranslate() + c * r.sensitivity;
      if (
        ...
        const e = { time: x(), delta: Math.abs(c), direction: Math.sign(c) },
          i =
            l &&
            e.time < l.time + 500 &&
            e.delta <= l.delta &&
    ...
    function m(e) {
      let s = t.$el;
      "container" !== t.params.mousewheel.eventsTarget &&
        (s = S(t.params.mousewheel.eventsTarget)),
        s[e]("mouseenter", c),
        s[e]("mouseleave", p),
        s[e]("wheel", h);
    }
    ...
    i("init", () => {
      ...
      i("destroy", () => {
        t.params.cssMode && f(), t.mousewheel.enabled && v();
      }),
      Object.assign(t.mousewheel, { enable: f, disable: v });
  }
  function de(e, t, s, i) {
    const n = u();
    return (
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".job__slider") &&
      new le(".job__slider", {
        modules: [ce, ue],
        observer: !0,
        observeParents: !0,
        ...
        autoHeight: !1,
        speed: 800,
        pagination: { el: ".job-pagination", clickable: !0, type: "fraction" },
        navigation: { nextEl: ".job-next", prevEl: ".job-prev" },
        breakpoints: {
          320: { slidesPerView: 1, spaceBetween: 16, autoHeight: !0 },
          479: { slidesPerView: 2, spaceBetween: 16, autoHeight: !0 },
          768: { slidesPerView: 3, spaceBetween: 16 },
          992: { slidesPerView: 4, spaceBetween: 16, autoHeight: !0 },
        },
        on: {},
      }),
      document.querySelector(".examples__slider") &&
        new le(".examples__slider", {
          modules: [ce],
          observer: !0,
          observeParents: !0,
          slidesPerView: 2,
          ...
          autoHeight: !1,
          speed: 800,
          navigation: { nextEl: ".examples-next", prevEl: ".examples-prev" },
          breakpoints: {
            320: { slidesPerView: 1, spaceBetween: 16, autoHeight: !0 },
            479: { slidesPerView: 2, spaceBetween: 16, autoHeight: !0 },
            768: { slidesPerView: 3, spaceBetween: 16 },
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (r = Ne(t, this.outer, l, a, this.currentImageSize))),
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              S = We(r, T || "", g, this.settings.strings.playVideo, h);
              n.prepend(S);
            } else if (h) {
          ...
          "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
            setTimeout(function () {
              ...
              if (
                ...
                var l = Be(s.target);
                n.isPosterElement(l) && n.LGel.trigger(Ie);
              }
